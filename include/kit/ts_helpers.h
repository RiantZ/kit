...
#if defined(_M_X64) || defined(__amd64__) || defined(__amd64) || defined(_WIN64) || defined(_WIN64_)                  \
    || defined(WIN64) || defined(__LP64__) || defined(_LP64) || defined(__x86_64__) || defined(__ppc64__)             \
    || defined(__aarch64__)
    #define GTX64
#else
    #define GTX32
